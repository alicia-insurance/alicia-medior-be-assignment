    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original_url', models.URLField(help_text='The original URL to be shortened.')),
                ('short_alias', models.CharField(help_text='Custom short alias for the URL, max 9 characters.', max_length=9, unique=True)),
